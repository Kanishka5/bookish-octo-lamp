...
window.addEventListener("load", function () {
  ...
  if ("serviceWorker" in navigator) {
    var serviceWorker = document.querySelector('meta[name="service-worker-js"]')
      .content;
  ...
  function initialiseState(reg) {
    ...
    if (!reg.showNotification) {
      ...
      messageBox.textContent =
        "Showing Notification is not suppoted in your browser";
    ...
    if (Notification.permission === "denied") {
      // Show a message and activate the button
      messageBox.textContent =
        "The Push Notification is blocked from your browser.";
      subBtn.textContent = "Subscribe to Push Messaging";
    ...
    if (!("PushManager" in window)) {
      // Show a message and activate the button
      messageBox.textContent =
        "Push Notification is not available in the browser";
      subBtn.textContent = "Subscribe to Push Messaging";
      subBtn.disabled = false;
      messageBox.style.display = "block";
      return;
